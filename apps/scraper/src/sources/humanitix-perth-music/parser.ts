...
import { extractHumanitixArtists } from "./artists";
import type {
  HumanitixPageMeta,
  HumanitixStructuredAddress,
  HumanitixStructuredEvent,
  ParsedHumanitixDiscoveryPage
} from "./types";
...
export type { ParsedHumanitixDiscoveryPage } from "./types";
export { extractHumanitixArtists } from "./artists";
...
export function repairHumanitixArtists(rawPayload: unknown) {
  const payload =
