...
export function getAppFirstPaintBackgroundStyle(): string {
  return `html{background-color:#121018;color-scheme:dark;}body{background-color:#121018;}html[data-mantine-color-scheme="light"]{background-color:rgb(241,239,233);color-scheme:light;}html[data-mantine-color-scheme="light"] body{background-color:rgb(241,239,233);}`;
}
